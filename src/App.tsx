...
const styles: Record<string, React.CSSProperties> = {
  ...
  characterSelectBoard: {
    ...
    minHeight: 0,
    display: "grid",
    gridTemplateColumns: "minmax(300px, 0.94fr) minmax(360px, 1.06fr)",
  ...
  characterSelectLeftColumn: {
    ...
    padding: "clamp(8px, 0.75vw, 12px) 0",
  ...
  characterNavDotActive: {
    ...
    height: "10px",
    background: "#d7a85f",
    boxShadow: "0 0 0 3px rgba(215,168,95,0.16)",
  },
  characterNavCounter: {
    fontSize: "13px",
    color: "#a77d4a",
  ...
  characterInfoPanel: {
    ...
    borderRadius: "22px",
    background: "linear-gradient(180deg, rgba(39,25,16,0.92) 0%, rgba(24,15,10,0.94) 100%)",
  ...
  characterStoryQuote: {
    ...
    paddingLeft: "16px",
    color: "#efd6ad",
    fontSize: "clamp(17px, 1.35vw, 24px)",
    lineHeight: 1.6,
    fontStyle: "italic",
    fontFamily: "Georgia, serif",
  },
